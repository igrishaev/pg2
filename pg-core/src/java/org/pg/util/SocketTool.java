...
public class SocketTool {
    ...
    public static void startHandshake(final SSLSocket socket) {
        try {
            ...
            throw new PGIOException(e, "cannot start handshake, cause: %s", e.getMessage());
        }
    }
    ...
    public static SocketChannel open(final SocketAddress address) {
        try {
            ...
            throw new PGIOException(e, "cannot open socket, address: %s, cause: %s", address, e.getMessage());
        }
    }
    ...
    public static SSLSocket open(final SSLContext sslContext,
        ...
        try {
            ...
            throw new PGIOException(e, "cannot open an SSL socket, socket: %s, host: %s, port: %s, cause: %s",
